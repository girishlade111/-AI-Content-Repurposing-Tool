    ...
    <div className="min-h-screen flex flex-col bg-dark-900 noise">
      ...
      <main className="flex-1 container py-8 mx-auto px-4 relative z-10">
        <div className="mb-8">
          ...
          <h1 className="text-3xl font-bold text-white">Social Publishing</h1>
          <p className="text-slate-400 mt-1">Connect accounts and publish directly to social platforms</p>
        </div>
