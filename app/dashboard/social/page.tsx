      ...
      <main className="flex-1 container py-12 mx-auto px-4 relative z-10">
        <div className="flex items-center justify-between mb-10 animate-fade-in-up">
          <div>
            ...
            <h1 className="text-4xl font-bold text-white mb-2">Social Publishing</h1>
            <p className="text-slate-400 text-lg">Connect accounts and publish directly to social platforms</p>
          </div>
          <Link href="/dashboard">
